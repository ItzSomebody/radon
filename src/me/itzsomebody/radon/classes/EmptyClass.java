...
public class EmptyClass {
    /**
     * Creates and returns a class object as {@link ClassNode} with a super class of java/lang/Object.
     *
     * @param name the {@link String} to be used as the empty class name.
     * @return Returns a class object as {@link ClassNode} with a super class of java/lang/Object
     */
    public static ClassNode emptyClass(String name) {
        ClassNode classNode = new ClassNode();
        classNode.visit(51, Opcodes.ACC_PUBLIC, name, null, "java/lang/Object", null);
