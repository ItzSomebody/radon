...
public class StringEncryption implements Opcodes {
    ...
    public static MethodNode lightMethod(String decryptMethodName) {
        ...
        Label l10 = new Label();
        mv.visitLabel(l10);
        mv.visitFrame(Opcodes.F_FULL, 6, new Object[]{"java/lang/Object", Opcodes.INTEGER, "[C", Opcodes.INTEGER, "[C", Opcodes.INTEGER}, 0, new Object[]{});
        ...
        mv.visitLabel(l2);
        mv.visitFrame(Opcodes.F_FULL, 2, new Object[]{"java/lang/Object", Opcodes.INTEGER}, 1, new Object[]{"java/lang/Throwable"});
        mv.visitVarInsn(ASTORE, 2);
        Label l13 = new Label();
        mv.visitLabel(l13);
        mv.visitVarInsn(ALOAD, 0);
        ...
        Label l19 = new Label();
        mv.visitLabel(l19);
        mv.visitFrame(Opcodes.F_FULL, 7, new Object[]{"java/lang/Object", Opcodes.INTEGER, "java/lang/Throwable", "[C", "[C", "[Ljava/lang/StackTraceElement;", Opcodes.INTEGER}, 0, new Object[]{});
