...
public class CLIMessages {
    ...
    public static void usageMsg() {
        LoggerUtils.stdOut("Usage: java -jar Radon.jar --config example.config");
    ...
    public static void helpMsg() {
        LoggerUtils.stdOut("CLI Usage:\t\tjava -jar Radon.jar --config example.config");
        LoggerUtils.stdOut("Credits:\t\tjava -jar Radon.jar --version");
        LoggerUtils.stdOut("Help Menu:\t\tjava -jar Radon.jar --help");
        LoggerUtils.stdOut("Watermark Extraction:\tjava -jar Radon.jar --extract Input.jar exampleKey");
        LoggerUtils.stdOut("GUI Usage:\t\tjava -jar Radon.jar");
    }

    /**
     * Prints version message into console.
     */
    public static void versionMsg() {
