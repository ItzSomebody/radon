...
public class ConfigurationParser {
    ...
    private File getInput() {
        ...
        if (!(o instanceof String)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.INPUT.getValue(), String.class, o.getClass());
        }
    ...
    private File getOutput() {
        ...
        if (!(o instanceof String)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.OUTPUT.getValue(), String.class, o.getClass());
        }
    ...
    private List<File> getLibraries() {
        ...
        if (!(o instanceof List)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.LIBRARIES.getValue(), List.class, o.getClass());
        }
        ...
        for (Object lib : libs) {
            try {
                ...
                throw new IllegalConfigurationValueException(ConfigurationSettings.LIBRARIES.getValue(), String.class, lib.getClass());
            }
        }
    ...
    private Shrinker getShrinkerTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.SHRINKER.getValue(), Map.class, o.getClass());
        }
    ...
    private Optimizer getOptimizerTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.OPTIMIZER.getValue(), Map.class, o.getClass());
        }
    ...
    private Renamer getRenamerTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.RENAMER.getValue(), Map.class, o.getClass());
        }
    ...
    private NumberObfuscation getNumberObfuscationTransformer() {
        ...
        if (!(o instanceof String)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.NUMBER_OBFUSCATION.getValue(), String.class, o.getClass());
        }
        String s = (String) o;
        if (!s.equals("Light") && !s.equals("Normal") && !s.equals("Heavy")) {
            throw new IllegalConfigurationValueException("Expected Light, Normal or Heavy as mode for number obfuscation. Got " + s + " instead.");
        }
    ...
    private InvokeDynamic getInvokeDynamicTransformer() {
        ...
        if (!(o instanceof String)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.INVOKEDYNAMIC.getValue(), String.class, o.getClass());
        }
        String s = (String) o;
        if (!s.equals("Light") && !s.equals("Normal") && !s.equals("Heavy")) {
            throw new IllegalConfigurationValueException("Expected Light, Normal or Heavy as mode for invokedynamic obfuscation. Got " + s + " instead.");
        }
    ...
    private List<StringEncryption> getStringEncryptionTransformers() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.STRING_ENCRYPTION.getValue(), Map.class, o.getClass());
        }
        ...
        if (!s.equals("Light") && !s.equals("Normal") && !s.equals("Heavy")) {
            throw new IllegalConfigurationValueException("Expected Light, Normal or Heavy as mode for string encryption. Got " + s + " instead.");
        }
    ...
    private FlowObfuscation getFlowObfuscationTransformer() {
        ...
        if (!(o instanceof String)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.FLOW_OBFUSCATION.getValue(), String.class, o.getClass());
        }
        String s = (String) o;
        if (!s.equals("Light") && !s.equals("Normal") && !s.equals("Heavy")) {
            throw new IllegalConfigurationValueException("Expected Light, Normal or Heavy as mode for flow obfuscation. Got " + s + " instead.");
        }
    ...
    private MemberShuffler getShufflerTransformer() {
        ...
        if (!(o instanceof Boolean)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.SHUFFLER.getValue(), Boolean.class, o.getClass());
        }
    ...
    private LocalVariables getLocalVariablesTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.LOCAL_VARIABLES.getValue(), Map.class, o.getClass());
        }
        ...
        try {
            ...
            throw new IllegalConfigurationValueException("Error while parsing local variable obfuscation setup: " + e.getMessage());
        }
    }
    ...
    private LineNumbers getLineNumbersTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.LINE_NUMBERS.getValue(), Map.class, o.getClass());
        }
        ...
        try {
            ...
            throw new IllegalConfigurationValueException("Error while parsing line number obfuscation setup: " + e.getMessage());
        }
    }
    ...
    private SourceName getSourceNameTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.SOURCE_NAME.getValue(), Map.class, o.getClass());
        }
        ...
        try {
            ...
            throw new IllegalConfigurationValueException("Error while parsing source name obfuscation setup: " + e.getMessage());
        }
    }
    ...
    private SourceDebug getSourceDebugTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.SOURCE_DEBUG.getValue(), Map.class, o.getClass());
        }
        ...
        try {
            ...
            throw new IllegalConfigurationValueException("Error while parsing source debug obfuscation setup: " + e.getMessage());
        }
    }
    ...
    private Crasher getCrasherTransformer() {
        ...
        if (!(o instanceof Boolean)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.CRASHER.getValue(), Boolean.class, o.getClass());
        }
    ...
    private HideCode getHideCodeTransformer() {
        ...
        if (!(o instanceof Boolean)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.HIDE_CODE.getValue(), Boolean.class, o.getClass());
        }
    ...
    private Expiration getExpirationTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.EXPIRATION.getValue(), Map.class, o.getClass());
        }
    ...
    private Watermarker getWatermarkerTransformer() {
        ...
        if (!(o instanceof Map)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.WATERMARK.getValue(), Map.class, o.getClass());
        }
    ...
    private ExclusionManager getExclusions() {
        ...
        if (!(o instanceof List)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.EXCLUSIONS.getValue(), List.class, o.getClass());
        }

        try {
            List<String> list = (List) o;
            list.forEach(s -> {
                exclusions.addExclusion(new Exclusion(s));
            });
        } catch (ClassCastException e) {
    ...
    private int getTrashClasses() {
        ...
        if (!(o instanceof Integer)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.TRASH_CLASSES.getValue(), Integer.class, o.getClass());
        }
        return (int) o;
    }
    ...
    private Dictionaries getDictionary() {
        ...
        if (!(o instanceof String) && !(o instanceof Integer)) {
            throw new IllegalConfigurationValueException(ConfigurationSettings.DICTIONARY.getValue(), String.class, o.getClass());
        }
        if (o instanceof String) {
